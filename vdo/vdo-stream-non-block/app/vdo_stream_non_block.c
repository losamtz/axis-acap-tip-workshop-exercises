/*
 * Exercise skeleton for vdo_stream_non_block.
 *
...
int main(void) {
    openlog("vdo_stream_non_block", LOG_PID, LOG_USER);

    syslog(LOG_INFO, "vdo_stream_non_block exercise skeleton started");
    ...
    syslog(LOG_INFO, "TODO: complete vdo_stream_non_block.c using the README implementation snippet");
