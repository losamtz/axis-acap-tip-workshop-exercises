/*
 * Exercise skeleton for vdo_stream_blocking.
 *
...
int main(void) {
    openlog("vdo_stream_blocking", LOG_PID, LOG_USER);

    syslog(LOG_INFO, "vdo_stream_blocking exercise skeleton started");
    ...
    syslog(LOG_INFO, "TODO: complete vdo_stream_blocking.c using the README implementation snippet");
