/*
 * Exercise skeleton for vdo_stream_events.
 *
...
int main(void) {
    ...
    syslog(LOG_INFO, "vdo_stream_events exercise skeleton started");
    ...
    syslog(LOG_INFO, "TODO: complete vdo_stream_events.c using the README implementation snippet");
