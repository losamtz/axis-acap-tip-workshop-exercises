...
int main(int argc, char** argv) {
    ...
    /* TODO 2: Create the NV12 stream with the VDO convenience constructor. */
    /* TODO 3: Get the stream fd, start the stream, and log NV12 stream info. */
    /* TODO 4: Poll the stream fd before fetching each NV12 buffer. */
