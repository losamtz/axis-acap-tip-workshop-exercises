/*
 * Exercise skeleton for vdo_stream_rgb.
 *
...
int main(void) {
    openlog("vdo_stream_rgb", LOG_PID, LOG_USER);

    syslog(LOG_INFO, "vdo_stream_rgb exercise skeleton started");
    ...
    syslog(LOG_INFO, "TODO: complete vdo_stream_rgb.c using the README implementation snippet");
