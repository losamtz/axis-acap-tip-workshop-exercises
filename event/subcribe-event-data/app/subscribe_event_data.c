/*
 * Exercise skeleton for subscribe_event_data.
 *
...
int main(void) {
    openlog("subscribe_event_data", LOG_PID, LOG_USER);

    syslog(LOG_INFO, "subscribe_event_data exercise skeleton started");
    ...
    syslog(LOG_INFO, "TODO: complete subscribe_event_data.c using the README implementation snippet");
