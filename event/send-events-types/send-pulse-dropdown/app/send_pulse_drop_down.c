/*
 * Exercise skeleton for send_pulse_drop_down.
 *
...
int main(void) {
    openlog("send_pulse_drop_down", LOG_PID, LOG_USER);

    syslog(LOG_INFO, "send_pulse_drop_down exercise skeleton started");
    ...
    syslog(LOG_INFO, "TODO: complete send_pulse_drop_down.c using the README implementation snippet");
