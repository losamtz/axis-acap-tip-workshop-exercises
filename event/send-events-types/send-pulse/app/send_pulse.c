/*
 * Exercise skeleton for send_pulse.
 *
...
int main(void) {
    openlog("send_pulse", LOG_PID, LOG_USER);

    syslog(LOG_INFO, "send_pulse exercise skeleton started");
    ...
    syslog(LOG_INFO, "TODO: complete send_pulse.c using the README implementation snippet");
