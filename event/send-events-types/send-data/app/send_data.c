/*
 * Exercise skeleton for send_data.
 *
...
int main(void) {
    openlog("send_data", LOG_PID, LOG_USER);

    syslog(LOG_INFO, "send_data exercise skeleton started");
    ...
    syslog(LOG_INFO, "TODO: complete send_data.c using the README implementation snippet");
