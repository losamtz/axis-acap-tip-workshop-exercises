/*
 * Exercise skeleton for send_state.
 *
...
int main(void) {
    openlog("send_state", LOG_PID, LOG_USER);

    syslog(LOG_INFO, "send_state exercise skeleton started");
    ...
    syslog(LOG_INFO, "TODO: complete send_state.c using the README implementation snippet");
