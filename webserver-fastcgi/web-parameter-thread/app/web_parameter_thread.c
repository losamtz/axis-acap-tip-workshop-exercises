/*
 * Exercise skeleton for web_parameter_thread.
 *
...
int main(void) {
    openlog("web_parameter_thread", LOG_PID, LOG_USER);

    syslog(LOG_INFO, "web_parameter_thread exercise skeleton started");
    ...
    syslog(LOG_INFO, "TODO: complete web_parameter_thread.c using the README implementation snippet");
