/*
 * Exercise skeleton for web_parameter.
 *
...
int main(void) {
    openlog("web_parameter", LOG_PID, LOG_USER);

    syslog(LOG_INFO, "web_parameter exercise skeleton started");
    ...
    syslog(LOG_INFO, "TODO: complete web_parameter.c using the README implementation snippet");
