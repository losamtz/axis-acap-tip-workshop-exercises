/*
 * Exercise skeleton for dynamic_overlay_vapix.
 *
...
int main(void) {
    openlog("dynamic_overlay_vapix", LOG_PID, LOG_USER);

    syslog(LOG_INFO, "dynamic_overlay_vapix exercise skeleton started");
    ...
    syslog(LOG_INFO, "TODO: complete dynamic_overlay_vapix.c using the README implementation snippet");
