/*
 * Exercise skeleton for overlay2_draw_views.
 *
...
int main(void) {
    ...
    syslog(LOG_INFO, "overlay2_draw_views exercise skeleton started");
    ...
    syslog(LOG_INFO, "TODO: complete overlay2_draw_views.c using the README implementation snippet");
