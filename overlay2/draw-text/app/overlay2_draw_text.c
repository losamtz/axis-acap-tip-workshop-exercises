/*
 * Exercise skeleton for overlay2_draw_text.
 *
...
int main(void) {
    ...
    syslog(LOG_INFO, "overlay2_draw_text exercise skeleton started");
    ...
    syslog(LOG_INFO, "TODO: complete overlay2_draw_text.c using the README implementation snippet");
