/*
 * Exercise skeleton for overlay2_add_logo.
 *
...
int main(void) {
    ...
    syslog(LOG_INFO, "overlay2_add_logo exercise skeleton started");
    ...
    syslog(LOG_INFO, "TODO: complete overlay2_add_logo.c using the README implementation snippet");
