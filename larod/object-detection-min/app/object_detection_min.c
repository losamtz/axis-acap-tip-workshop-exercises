/*
 * Exercise skeleton for object_detection_min.
 *
...
int main(void) {
    openlog("object_detection_min", LOG_PID, LOG_USER);

    syslog(LOG_INFO, "object_detection_min exercise skeleton started");
    ...
    syslog(LOG_INFO, "TODO: complete object_detection_min.c using the README implementation snippet");
