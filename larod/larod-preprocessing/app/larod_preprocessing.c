/*
 * Exercise skeleton for larod_preprocessing.
 *
...
int main(void) {
    openlog("larod_preprocessing", LOG_PID, LOG_USER);

    syslog(LOG_INFO, "larod_preprocessing exercise skeleton started");
    ...
    syslog(LOG_INFO, "TODO: complete larod_preprocessing.c using the README implementation snippet");
