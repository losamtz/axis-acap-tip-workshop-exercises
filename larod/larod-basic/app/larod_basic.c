/*
 * Exercise skeleton for larod_basic.
 *
...
int main(void) {
    openlog("larod_basic", LOG_PID, LOG_USER);

    syslog(LOG_INFO, "larod_basic exercise skeleton started");
    ...
    syslog(LOG_INFO, "TODO: complete larod_basic.c using the README implementation snippet");
