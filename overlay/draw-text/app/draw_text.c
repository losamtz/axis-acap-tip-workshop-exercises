...
int main(void) {
    ...
    /* TODO 4: Create a full-frame ARGB32 overlay for text rendering. */
    /* TODO 5: Request redraw, start the redraw timer, and run the main loop. */
    /* TODO 6: Destroy the overlay, stop the timer, clean up axoverlay, and release the loop. */
