/*
 * Exercise skeleton for draw_text.
 *
...
int main(void) {
    openlog("draw_text", LOG_PID, LOG_USER);

    syslog(LOG_INFO, "draw_text exercise skeleton started");
    ...
    syslog(LOG_INFO, "TODO: complete draw_text.c using the README implementation snippet");
