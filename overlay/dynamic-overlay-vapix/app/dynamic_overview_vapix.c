/*
 * Exercise skeleton for dynamic_overview_vapix.
 *
...
int main(void) {
    openlog("dynamic_overview_vapix", LOG_PID, LOG_USER);

    syslog(LOG_INFO, "dynamic_overview_vapix exercise skeleton started");
    ...
    syslog(LOG_INFO, "TODO: complete dynamic_overview_vapix.c using the README implementation snippet");
