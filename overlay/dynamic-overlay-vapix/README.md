...
The source file `app/dynamic_overview_vapix.c` has been reduced to a small TODO skeleton.

Your task is to rebuild the application flow by pasting the snippet below into `app/dynamic_overview_vapix.c`.
The snippet is intentionally kept in the README so you can read the sequence before editing the C file.

## What to do

1. Open `app/dynamic_overview_vapix.c`.
...
Paste this into `app/dynamic_overview_vapix.c`:
