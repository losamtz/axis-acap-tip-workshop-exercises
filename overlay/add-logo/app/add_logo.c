/*
 * Exercise skeleton for add_logo.
 *
...
int main(void) {
    openlog("add_logo", LOG_PID, LOG_USER);

    syslog(LOG_INFO, "add_logo exercise skeleton started");
    ...
    syslog(LOG_INFO, "TODO: complete add_logo.c using the README implementation snippet");
