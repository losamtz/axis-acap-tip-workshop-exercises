/*
 * Exercise skeleton for draw_views.
 *
...
int main(void) {
    openlog("draw_views", LOG_PID, LOG_USER);

    syslog(LOG_INFO, "draw_views exercise skeleton started");
    ...
    syslog(LOG_INFO, "TODO: complete draw_views.c using the README implementation snippet");
