/*
 * Exercise skeleton for web_proxy.
 *
...
int main(void) {
    openlog("web_proxy", LOG_PID, LOG_USER);

    syslog(LOG_INFO, "web_proxy exercise skeleton started");
    ...
    syslog(LOG_INFO, "TODO: complete web_proxy.c using the README implementation snippet");
