/*
 * Exercise skeleton for web_proxy_angular_route.
 *
...
int main(void) {
    openlog("web_proxy_angular_route", LOG_PID, LOG_USER);

    syslog(LOG_INFO, "web_proxy_angular_route exercise skeleton started");
    ...
    syslog(LOG_INFO, "TODO: complete web_proxy_angular_route.c using the README implementation snippet");
