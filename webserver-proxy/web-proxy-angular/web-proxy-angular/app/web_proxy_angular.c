/*
 * Exercise skeleton for web_proxy_angular.
 *
...
int main(void) {
    openlog("web_proxy_angular", LOG_PID, LOG_USER);

    syslog(LOG_INFO, "web_proxy_angular exercise skeleton started");
    ...
    syslog(LOG_INFO, "TODO: complete web_proxy_angular.c using the README implementation snippet");
