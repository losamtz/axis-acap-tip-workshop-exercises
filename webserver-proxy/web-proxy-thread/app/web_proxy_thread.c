/*
 * Exercise skeleton for web_proxy_thread.
 *
...
int main(void) {
    openlog("web_proxy_thread", LOG_PID, LOG_USER);

    syslog(LOG_INFO, "web_proxy_thread exercise skeleton started");
    ...
    syslog(LOG_INFO, "TODO: complete web_proxy_thread.c using the README implementation snippet");
