/*
 * Exercise skeleton for parameter_runtime.
 *
...
int main(void) {
    openlog("parameter_runtime", LOG_PID, LOG_USER);

    syslog(LOG_INFO, "parameter_runtime exercise skeleton started");
    ...
    syslog(LOG_INFO, "TODO: complete parameter_runtime.c using the README implementation snippet");
