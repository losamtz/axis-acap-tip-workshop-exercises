/*
 * Exercise skeleton for bbox_view.
 *
...
int main(void) {
    openlog("bbox_view", LOG_PID, LOG_USER);

    syslog(LOG_INFO, "bbox_view exercise skeleton started");
    ...
    syslog(LOG_INFO, "TODO: complete bbox_view.c using the README implementation snippet");
