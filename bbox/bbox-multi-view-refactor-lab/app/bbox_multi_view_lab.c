/*
 * Exercise skeleton for bbox_multi_view_lab.
 *
...
int main(void) {
    openlog("bbox_multi_view_lab", LOG_PID, LOG_USER);

    syslog(LOG_INFO, "bbox_multi_view_lab exercise skeleton started");
    ...
    syslog(LOG_INFO, "TODO: complete bbox_multi_view_lab.c using the README implementation snippet");
