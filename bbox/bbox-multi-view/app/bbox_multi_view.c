/*
 * Exercise skeleton for bbox_multi_view.
 *
...
int main(void) {
    openlog("bbox_multi_view", LOG_PID, LOG_USER);

    syslog(LOG_INFO, "bbox_multi_view exercise skeleton started");
    ...
    syslog(LOG_INFO, "TODO: complete bbox_multi_view.c using the README implementation snippet");
